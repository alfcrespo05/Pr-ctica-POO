// Trabajo POO_2.cpp : Este archivo contiene la función "main". La ejecución del programa comienza y termina ahí.
//
...
int main() {
    ...
    std::cout << "Bienvenido a la Biblioteca Universitaria.\n";
    lib.ejecutar();
